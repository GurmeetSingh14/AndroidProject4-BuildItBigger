 ...
 * on 2016-01-17 at 11:51:19 UTC 
 * Modify at your own risk.
 */

package com.example.gurmeet.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://builditbigger-1192.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.example.gurmeet.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.gurmeet.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.gurmeet.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.gurmeet.myapplication.backend.myApi.model.MyBean.class);
